 ...
 */
    ...
    $translation['uploaded_too_big_ini']        = 'Hata oluştu (izin verilen boyuttan büyük dosya yüklemezsiniz. Ancak php.ini dosyasından upload_max_filesize değerini yükselterek tekrar deneyebilirsiniz.).';
    $translation['uploaded_too_big_html']       = 'Hata oluştu (sayfanızda belirttiğiniz MAX_FILE_SIZE boyutundan büyük bir dosya yüklemezsiniz.).';
    ...
    $translation['gd_missing']                  = 'İşleme devam edemiyorsunuz. Bu sunucunun GD kütüphanesine ihtiyacı var.';
