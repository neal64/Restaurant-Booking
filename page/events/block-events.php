<h1 class="text-left"><?php echo $lang['Events']; ?> (<a title="<?php echo $lang['AllActiveEvents']; ?>" href="<?php echo $CONF['installation_path']; ?>page/events/"><?php echo $lang['AllActiveEvents']; ?></a>)</h1>
<?php
$today = date('Y-m-d');
